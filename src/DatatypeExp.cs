...
class DatatypeExp
{
    public static void Main(string[] args)
    {
        ...
        void DatatypeIntDoubleAndFloatEXP()
        {
        ...
        void DatatypeString()
        {
            string myStringVariable = "PradeepKumar";
            Console.WriteLine("Varaibale mySringVariable::{0}", myStringVariable);
            Console.WriteLine($"Varaibale mySringVariable::{myStringVariable.Length}");
            Console.WriteLine($"Varaibale mySringVariable::{myStringVariable}");
        }
        /**
         Invoke Methods
        */
        // DatatypeIntDoubleAndFloatEXP();
        DatatypeString();
    }
